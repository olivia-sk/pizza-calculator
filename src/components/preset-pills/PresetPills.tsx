 ...
 *
 * Shaped like every other control in the app (rounded-xl) rather than as a
 * capsule, so a row of them reads as buttons you press and not as status chips.
 */
      ...
      {presets.map((preset) => {
        ...
        return (
          <button
            ...
            className={cn(
              "flex min-h-[36px] items-center gap-1.5 rounded-xl border px-3 text-xs font-medium",
